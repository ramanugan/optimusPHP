<?
        ...
        include ('/var/www/html/config.custom.php');
        include ('/var/www/html/config.php');
        include ('/var/www/html/tools/push.php');
        include ('/var/www/html/tools/email.php');
        include ('/var/www/html/tools/sms.php');
        include ('/var/www/html/tools/webhook.php');
