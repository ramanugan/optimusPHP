<?
	...
	// #################################################
        ...
        {
                $style .= '#top_panel .user-btn span, #top_panel .user-list-btn span, #top_panel .object-list-btn span, #top_panel .billing-plan-list-btn span, #top_panel .unused-object-list-btn span, #top_panel .imei-server-btn span, #top_panel .device-server-btn span { color: '.$theme["ui_top_panel_font_color"].'; }';     
        }
