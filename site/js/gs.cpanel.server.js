		...
		case "server":
			...
			$.ajax({
				...
				{					
					...
					document.getElementById('cpanel_manage_server_api_ip').value = result['server_api_ip'];
					...
					document.getElementById('cpanel_manage_server_help_page').value = result['help_page'];
					...
					document.getElementById('cpanel_manage_server_show_hide_password').value = result['show_hide_password'];
					...
					document.getElementById('cpanel_manage_server_user_show_update_dialog').value = result['user_show_update_dialog'];		
					...
					// ===================== Bronce =====================
					document.getElementById('cpanel_manage_server_perm_eventos').value = result['perm_eventos'];
					document.getElementById('cpanel_manage_server_perm_alertas').value = result['perm_alertas'];
					document.getElementById('cpanel_manage_server_perm_geocercas').value = result['perm_geocercas'];
					document.getElementById('cpanel_manage_server_perm_historial').value = result['perm_historial'];
					
					
					// ===================== Lista de GPS =====================
					document.getElementById('cpanel_manage_server_perm_buscar_gps').value = result['perm_buscar_gps'];
					document.getElementById('cpanel_manage_server_perm_refrescar').value = result['perm_refrescar'];
					document.getElementById('cpanel_manage_server_perm_compartir_unidad').value = result['perm_compartir_unidad'];
					document.getElementById('cpanel_manage_server_perm_agregar_unidad').value = result['perm_agregar_unidad'];
					document.getElementById('cpanel_manage_server_perm_mostrar_ocultar').value = result['perm_mostrar_ocultar'];
					document.getElementById('cpanel_manage_server_perm_seguimiento').value = result['perm_seguimiento'];
					
					
					// ===================== Editar Lista de GPS =====================
					document.getElementById('cpanel_manage_server_perm_historial_edit').value = result['perm_historial_edit'];
					document.getElementById('cpanel_manage_server_perm_vista_calle').value = result['perm_vista_calle'];
					document.getElementById('cpanel_manage_server_perm_enviar_comando').value = result['perm_enviar_comando'];
					document.getElementById('cpanel_manage_server_perm_editar').value = result['perm_editar'];
					document.getElementById('cpanel_manage_server_perm_ver_en_vivo').value = result['perm_ver_en_vivo'];
					document.getElementById('cpanel_manage_server_perm_ver_eventos_camara').value = result['perm_ver_eventos_camara'];
					document.getElementById('cpanel_manage_server_perm_lista_datos').value = result['perm_lista_datos'];
					document.getElementById('cpanel_manage_server_perm_lista_marcadores').value = result['perm_lista_marcadores'];
					document.getElementById('cpanel_manage_server_perm_lista_zonas').value = result['perm_lista_zonas'];
					document.getElementById('cpanel_manage_server_perm_lista_rutas').value = result['perm_lista_rutas'];
					
					
					// ===================== Top Panel =====================
					document.getElementById('cpanel_manage_server_perm_acerca_de').value = result['perm_acerca_de'];
					document.getElementById('cpanel_manage_server_perm_info').value = result['perm_info'];
					document.getElementById('cpanel_manage_server_perm_configuracion').value = result['perm_configuracion'];
					document.getElementById('cpanel_manage_server_perm_coordenadas').value = result['perm_coordenadas'];
					document.getElementById('cpanel_manage_server_perm_buscar').value = result['perm_buscar'];
					document.getElementById('cpanel_manage_server_perm_reportes').value = result['perm_reportes'];
					document.getElementById('cpanel_manage_server_perm_tareas').value = result['perm_tareas'];
					document.getElementById('cpanel_manage_server_perm_mantenimientos').value = result['perm_mantenimientos'];
					document.getElementById('cpanel_manage_server_perm_comandos').value = result['perm_comandos'];
					document.getElementById('cpanel_manage_server_perm_grafica_combustible').value = result['perm_grafica_combustible'];
					document.getElementById('cpanel_manage_server_perm_grafica_temperatura').value = result['perm_grafica_temperatura'];
					document.getElementById('cpanel_manage_server_perm_imagenes').value = result['perm_imagenes'];
					document.getElementById('cpanel_manage_server_perm_chat').value = result['perm_chat'];
					document.getElementById('cpanel_manage_server_perm_lenguaje').value = result['perm_lenguaje'];
					document.getElementById('cpanel_manage_server_perm_mi_cuenta').value = result['perm_mi_cuenta'];
					document.getElementById('cpanel_manage_server_perm_version_celular').value = result['perm_version_celular'];
					
					
					// ===================== Editar Top Panel =====================
					document.getElementById('cpanel_manage_server_perm_gps').value = result['perm_gps'];
					document.getElementById('cpanel_manage_server_perm_plantillas').value = result['perm_plantillas'];
					document.getElementById('cpanel_manage_server_perm_kml').value = result['perm_kml'];
					document.getElementById('cpanel_manage_server_perm_gprs').value = result['perm_gprs'];
					document.getElementById('cpanel_manage_server_perm_sms').value = result['perm_sms'];
					document.getElementById('cpanel_manage_server_perm_crear_eventos').value = result['perm_crear_eventos'];
					document.getElementById('cpanel_manage_server_perm_interfaz_usuario').value = result['perm_interfaz_usuario'];
					document.getElementById('cpanel_manage_server_perm_subcuentas').value = result['perm_subcuentas'];
					document.getElementById('cpanel_manage_server_perm_grupos').value = result['perm_grupos'];
					document.getElementById('cpanel_manage_server_perm_conductor').value = result['perm_conductor'];
					document.getElementById('cpanel_manage_server_perm_pasajero').value = result['perm_pasajero'];
					document.getElementById('cpanel_manage_server_perm_trailer').value = result['perm_trailer'];
					document.getElementById('cpanel_manage_server_perm_logs').value = result['perm_logs'];
					
					
					// ===================== Reportes =====================
					document.getElementById('cpanel_manage_server_perm_crear_reportes').value = result['perm_crear_reportes'];
					document.getElementById('cpanel_manage_server_perm_ver_reportes').value = result['perm_ver_reportes'];
					document.getElementById('cpanel_manage_server_perm_eliminar_reportes').value = result['perm_eliminar_reportes'];
					document.getElementById('cpanel_manage_server_perm_editar_reportes').value = result['perm_editar_reportes'];
					
					
					// ===================== Mantenimiento =====================
					document.getElementById('cpanel_manage_server_perm_crear_mantenimiento').value = result['perm_crear_mantenimiento'];
					document.getElementById('cpanel_manage_server_perm_eliminar_mantenimientos').value = result['perm_eliminar_mantenimientos'];
					document.getElementById('cpanel_manage_server_perm_editar_mantenimientos').value = result['perm_editar_mantenimientos'];
					
					
					// ===================== Comandos =====================
					document.getElementById('cpanel_manage_server_perm_crear_comandos_gprs').value = result['perm_crear_comandos_gprs'];
					document.getElementById('cpanel_manage_server_perm_crear_comandos_sms').value = result['perm_crear_comandos_sms'];
					document.getElementById('cpanel_manage_server_perm_plantillas_comandos').value = result['perm_plantillas_comandos'];
					document.getElementById('cpanel_manage_server_perm_programar_comandos').value = result['perm_programar_comandos'];
					
					
					// ===================== Mapa =====================
					document.getElementById('cpanel_manage_server_perm_activar_desactivar_tools').value = result['perm_activar_desactivar_tools'];
					document.getElementById('cpanel_manage_server_perm_marcadores_mapa').value = result['perm_marcadores_mapa'];
					document.getElementById('cpanel_manage_server_perm_rutas_mapa').value = result['perm_rutas_mapa'];
					document.getElementById('cpanel_manage_server_perm_geocercas_mapa').value = result['perm_geocercas_mapa'];
					...
					document.getElementById('cpanel_manage_server_dashboard').value = result['dashboard'];
					...
					document.getElementById('cpanel_manage_server_tachograph').value = result['tachograph'];
					...
					document.getElementById('cpanel_manage_server_expenses').value = result['expenses'];
					...
					document.getElementById('cpanel_manage_server_usage_webhook_daily').value = result['usage_webhook_daily'];
...
function apiKeyReset()
{
		confirmDialog(la['ARE_YOU_SURE_YOU_WANT_TO_RESET_SERVER_API_KEY'], function(response){
		if (response)
		{
			var data = {
				cmd: 'reset_server_api_key'
			};
			...
			$.ajax({
				...
				success: function(result)
				{
					document.getElementById('cpanel_manage_server_api_key').value = result.api_key;
				}
			});
		}
	});
...
function serverSave()
{
	...
	if (db_backup_email !== '' && db_backup_email.indexOf('@') === -1) 
	{
	...
	var user_show_update_dialog = document.getElementById('cpanel_manage_server_user_show_update_dialog').value;
	...
	var usage_webhook_daily = document.getElementById('cpanel_manage_server_usage_webhook_daily').value;
	if ((usage_webhook_daily < 1) || !isIntValid(usage_webhook_daily))
	{
	...
	var items = {
		...
		server_api_ip: document.getElementById('cpanel_manage_server_api_ip').value,
		...
		help_page: document.getElementById('cpanel_manage_server_help_page').value,
		...
		show_hide_password: document.getElementById('cpanel_manage_server_show_hide_password').value,
		...
		user_show_update_dialog: user_show_update_dialog,
		...
		dashboard: document.getElementById('cpanel_manage_server_dashboard').value,
		...
		tachograph: document.getElementById('cpanel_manage_server_tachograph').value,
		...
		expenses: document.getElementById('cpanel_manage_server_expenses').value,
		...
		perm_eventos: document.getElementById('cpanel_manage_server_perm_eventos').value,
		perm_alertas: document.getElementById('cpanel_manage_server_perm_alertas').value,
		perm_geocercas: document.getElementById('cpanel_manage_server_perm_geocercas').value,
		perm_historial: document.getElementById('cpanel_manage_server_perm_historial').value,
		
		perm_buscar_gps: document.getElementById('cpanel_manage_server_perm_buscar_gps').value,
		perm_refrescar: document.getElementById('cpanel_manage_server_perm_refrescar').value,
		perm_compartir_unidad: document.getElementById('cpanel_manage_server_perm_compartir_unidad').value,
		perm_agregar_unidad: document.getElementById('cpanel_manage_server_perm_agregar_unidad').value,
		perm_mostrar_ocultar: document.getElementById('cpanel_manage_server_perm_mostrar_ocultar').value,
		perm_seguimiento: document.getElementById('cpanel_manage_server_perm_seguimiento').value,
		
		perm_historial_edit: document.getElementById('cpanel_manage_server_perm_historial_edit').value,
		perm_vista_calle: document.getElementById('cpanel_manage_server_perm_vista_calle').value,
		perm_enviar_comando: document.getElementById('cpanel_manage_server_perm_enviar_comando').value,
		perm_editar: document.getElementById('cpanel_manage_server_perm_editar').value,
		perm_ver_en_vivo: document.getElementById('cpanel_manage_server_perm_ver_en_vivo').value,
		perm_ver_eventos_camara: document.getElementById('cpanel_manage_server_perm_ver_eventos_camara').value,
		perm_lista_datos: document.getElementById('cpanel_manage_server_perm_lista_datos').value,
		perm_lista_marcadores: document.getElementById('cpanel_manage_server_perm_lista_marcadores').value,
		perm_lista_zonas: document.getElementById('cpanel_manage_server_perm_lista_zonas').value,
		perm_lista_rutas: document.getElementById('cpanel_manage_server_perm_lista_rutas').value,
		
		perm_acerca_de: document.getElementById('cpanel_manage_server_perm_acerca_de').value,
		perm_info: document.getElementById('cpanel_manage_server_perm_info').value,
		perm_configuracion: document.getElementById('cpanel_manage_server_perm_configuracion').value,
		perm_coordenadas: document.getElementById('cpanel_manage_server_perm_coordenadas').value,
		perm_buscar: document.getElementById('cpanel_manage_server_perm_buscar').value,
		perm_reportes: document.getElementById('cpanel_manage_server_perm_reportes').value,
		perm_tareas: document.getElementById('cpanel_manage_server_perm_tareas').value,
		perm_mantenimientos: document.getElementById('cpanel_manage_server_perm_mantenimientos').value,
		perm_comandos: document.getElementById('cpanel_manage_server_perm_comandos').value,
		perm_grafica_combustible: document.getElementById('cpanel_manage_server_perm_grafica_combustible').value,
		perm_grafica_temperatura: document.getElementById('cpanel_manage_server_perm_grafica_temperatura').value,
		perm_imagenes: document.getElementById('cpanel_manage_server_perm_imagenes').value,
		perm_chat: document.getElementById('cpanel_manage_server_perm_chat').value,
		perm_lenguaje: document.getElementById('cpanel_manage_server_perm_lenguaje').value,
		perm_mi_cuenta: document.getElementById('cpanel_manage_server_perm_mi_cuenta').value,
		perm_version_celular: document.getElementById('cpanel_manage_server_perm_version_celular').value,
		
		perm_gps: document.getElementById('cpanel_manage_server_perm_gps').value,
		perm_plantillas: document.getElementById('cpanel_manage_server_perm_plantillas').value,
		perm_kml: document.getElementById('cpanel_manage_server_perm_kml').value,
		perm_gprs: document.getElementById('cpanel_manage_server_perm_gprs').value,
		perm_sms: document.getElementById('cpanel_manage_server_perm_sms').value,
		perm_crear_eventos: document.getElementById('cpanel_manage_server_perm_crear_eventos').value,
		perm_interfaz_usuario: document.getElementById('cpanel_manage_server_perm_interfaz_usuario').value,
		perm_subcuentas: document.getElementById('cpanel_manage_server_perm_subcuentas').value,
		
		perm_grupos: document.getElementById('cpanel_manage_server_perm_grupos').value,
		perm_conductor: document.getElementById('cpanel_manage_server_perm_conductor').value,
		perm_pasajero: document.getElementById('cpanel_manage_server_perm_pasajero').value,
		perm_trailer: document.getElementById('cpanel_manage_server_perm_trailer').value,
		perm_logs: document.getElementById('cpanel_manage_server_perm_logs').value,
		
		perm_crear_reportes: document.getElementById('cpanel_manage_server_perm_crear_reportes').value,
		perm_ver_reportes: document.getElementById('cpanel_manage_server_perm_ver_reportes').value,
		perm_eliminar_reportes: document.getElementById('cpanel_manage_server_perm_eliminar_reportes').value,
		perm_editar_reportes: document.getElementById('cpanel_manage_server_perm_editar_reportes').value,
		
		perm_crear_mantenimiento: document.getElementById('cpanel_manage_server_perm_crear_mantenimiento').value,
		perm_eliminar_mantenimientos: document.getElementById('cpanel_manage_server_perm_eliminar_mantenimientos').value,
		perm_editar_mantenimientos: document.getElementById('cpanel_manage_server_perm_editar_mantenimientos').value,
		
		perm_crear_comandos_gprs: document.getElementById('cpanel_manage_server_perm_crear_comandos_gprs').value,
		perm_crear_comandos_sms: document.getElementById('cpanel_manage_server_perm_crear_comandos_sms').value,
		perm_plantillas_comandos: document.getElementById('cpanel_manage_server_perm_plantillas_comandos').value,
		perm_programar_comandos: document.getElementById('cpanel_manage_server_perm_programar_comandos').value,
		
		perm_activar_desactivar_tools: document.getElementById('cpanel_manage_server_perm_activar_desactivar_tools').value,
		perm_marcadores_mapa: document.getElementById('cpanel_manage_server_perm_marcadores_mapa').value,
		perm_rutas_mapa: document.getElementById('cpanel_manage_server_perm_rutas_mapa').value,
		perm_geocercas_mapa: document.getElementById('cpanel_manage_server_perm_geocercas_mapa').value
	};
...
function uploadFaviconFile(evt)
{
	...
	reader.onloadend = function(event)
	{
		...
		if ((files[0].type != ('image/png')) && (files[0].type != ('image/x-icon')))
		{
			notifyDialog(la['FILE_TYPE_MUST_BE_PNG_OR_ICO']);
			return;
		}
		...
		image.onload = function () {			
			if (image.src.includes("image/png"))
			{
				...
				var url = "func/fn_upload.php?file=favicon_png";
			}
			else
			{
				var url = "func/fn_upload.php?file=favicon_ico";
			}
			...
			switch (name)
			{
				...
				case "event_email":
					variables = 	'<div class="row">'+la['VAR_TEMPLATE_NAME']+'</div>\
									...
									<div class="row">'+la['VAR_TEMPLATE_ROUTE']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_ZONE']+'</div>\
									...
									<div class="row">'+la['VAR_TEMPLATE_VIN']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_PL_NUM']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_SIM_NUMBER']+'</div>\
				...
				case "share_position_su_email":
					variables = 	'<div class="row">'+la['VAR_TEMPLATE_SERVER_NAME']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_USER_EMAIL']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_NAME']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_URL_SU']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_URL_SU_MOBILE']+'</div>';	
					break;
				
				case "share_position_su_sms":
					variables = 	'<div class="row">'+la['VAR_TEMPLATE_SERVER_NAME']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_USER_EMAIL']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_NAME']+'</div>\
									<div class="row">'+la['VAR_TEMPLATE_URL_SU']+'</div>\
