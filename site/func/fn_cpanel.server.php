...
if (@$_POST['cmd'] == 'load_server_data') {
	...
	$result = array(
		...
		'server_api_ip' => $gsValues['SERVER_API_IP'],
		...
		'show_hide_password' => $gsValues['SHOW_HIDE_PASSWORD'],
		...
		'user_show_update_dialog' => $gsValues['USER_SHOW_UPDATE_DIALOG'],
		...
		'usage_webhook_daily' => $gsValues['USAGE_WEBHOOK_DAILY'],
        ...
        // Bronce
		'perm_eventos'                  => $gsValues['PERM_EVENTOS'],
		'perm_alertas'                  => $gsValues['PERM_ALERTAS'],
		'perm_geocercas'                => $gsValues['PERM_GEOCERCAS'],
		'perm_historial'                => $gsValues['PERM_HISTORIAL'],

		// Lista de gps
		'perm_buscar_gps'               => $gsValues['PERM_BUSCAR_GPS'],
		'perm_refrescar'                => $gsValues['PERM_REFRESCAR'],
		'perm_compartir_unidad'         => $gsValues['PERM_COMPARTIR_UNIDAD'],
		'perm_agregar_unidad'           => $gsValues['PERM_AGREGAR_UNIDAD'],
		'perm_mostrar_ocultar'          => $gsValues['PERM_MOSTRAR_OCULTAR'],
		'perm_seguimiento'              => $gsValues['PERM_SEGUIMIENTO'],
		
		// Edit Lista de gps
		'perm_historial_edit'           => $gsValues['PERM_HISTORIAL_EDIT'],
		'perm_vista_calle'              => $gsValues['PERM_VISTA_CALLE'],
		'perm_enviar_comando'           => $gsValues['PERM_ENVIAR_COMANDO'],
		'perm_editar'                   => $gsValues['PERM_EDITAR'],
		'perm_ver_en_vivo'              => $gsValues['PERM_VER_EN_VIVO'],
		'perm_ver_eventos_camara'       => $gsValues['PERM_VER_EVENTOS_CAMARA'],
		'perm_lista_datos'              => $gsValues['PERM_LISTA_DATOS'],
		'perm_lista_marcadores'         => $gsValues['PERM_LISTA_MARCADORES'],
		'perm_lista_zonas'              => $gsValues['PERM_LISTA_ZONAS'],
		'perm_lista_rutas'              => $gsValues['PERM_LISTA_RUTAS'],
		
		// Top panel
		'perm_acerca_de'                => $gsValues['PERM_ACERCA_DE'],
		'perm_info'                     => $gsValues['PERM_INFO'],
		'perm_configuracion'            => $gsValues['PERM_CONFIGURACION'],
		'perm_coordenadas'              => $gsValues['PERM_COORDENADAS'],
		'perm_buscar'                   => $gsValues['PERM_BUSCAR'],
		'perm_reportes'                 => $gsValues['PERM_REPORTES'],
		'perm_tareas'                   => $gsValues['PERM_TAREAS'],
		'perm_mantenimientos'           => $gsValues['PERM_MANTENIMIENTOS'],
		'perm_comandos'                 => $gsValues['PERM_COMANDOS'],
		'perm_grafica_combustible'      => $gsValues['PERM_GRAFICA_COMBUSTIBLE'],
		'perm_grafica_temperatura'      => $gsValues['PERM_GRAFICA_TEMPERATURA'],
		'perm_imagenes'                 => $gsValues['PERM_IMAGENES'],
		'perm_chat'                     => $gsValues['PERM_CHAT'],
		'perm_lenguaje'                 => $gsValues['PERM_LENGUAJE'],
		'perm_mi_cuenta'                => $gsValues['PERM_MI_CUENTA'],
		'perm_version_celular'          => $gsValues['PERM_VERSION_CELULAR'],
		
		// Edit Top Panel
		'perm_gps'                      => $gsValues['PERM_GPS'],
		'perm_plantillas'               => $gsValues['PERM_PLANTILLAS'],
		'perm_kml'                      => $gsValues['PERM_KML'],
		'perm_gprs'                     => $gsValues['PERM_GPRS'],
		'perm_sms'                      => $gsValues['PERM_SMS'],
		'perm_crear_eventos'            => $gsValues['PERM_CREAR_EVENTOS'],
		'perm_interfaz_usuario'         => $gsValues['PERM_INTERFAZ_USUARIO'],
		'perm_subcuentas'               => $gsValues['PERM_SUBCUENTAS'],
		'perm_grupos'                   => $gsValues['PERM_GRUPOS'],
		'perm_conductor'                => $gsValues['PERM_CONDUCTOR'],
		'perm_pasajero'                 => $gsValues['PERM_PASAJERO'],
		'perm_trailer'                  => $gsValues['PERM_TRAILER'],
		'perm_logs'                     => $gsValues['PERM_LOGS'],
		
		// Reportes
		'perm_crear_reportes'           => $gsValues['PERM_CREAR_REPORTES'],
		'perm_ver_reportes'             => $gsValues['PERM_VER_REPORTES'],
		'perm_eliminar_reportes'        => $gsValues['PERM_ELIMINAR_REPORTES'],
		'perm_editar_reportes'          => $gsValues['PERM_EDITAR_REPORTES'],

		// Mtto
		'perm_crear_mantenimiento'      => $gsValues['PERM_CREAR_MANTENIMIENTO'],
		'perm_eliminar_mantenimientos'  => $gsValues['PERM_ELIMINAR_MANTENIMIENTOS'],
		'perm_editar_mantenimientos'    => $gsValues['PERM_EDITAR_MANTENIMIENTOS'],
		
		// Comandos
		'perm_crear_comandos_gprs'      => $gsValues['PERM_CREAR_COMANDOS_GPRS'],
		'perm_crear_comandos_sms'       => $gsValues['PERM_CREAR_COMANDOS_SMS'],
		'perm_plantillas_comandos'      => $gsValues['PERM_PLANTILLAS_COMANDOS'],
		'perm_programar_comandos'       => $gsValues['PERM_PROGRAMAR_COMANDOS'],
		
		// Edit Mapa
		'perm_activar_desactivar_tools' => $gsValues['PERM_ACTIVAR_DESACTIVAR_TOOLS'],
		'perm_marcadores_mapa'          => $gsValues['PERM_MARCADORES_MAPA'],
		'perm_rutas_mapa'               => $gsValues['PERM_RUTAS_MAPA'],
...
if (@$_POST['cmd'] == 'reset_server_api_key') {
	if ($_SESSION["cpanel_privileges"] != 'super_admin') {
		die;
	}

	$api_key = genServerAPIKey();
...
if (@$_POST['cmd'] == 'delete_favicon') {
	...
	$file = $gsValues['PATH_ROOT'] . 'favicon.png';
	if (is_file($file)) {
		@unlink($file);
	}
...
if (@$_POST['cmd'] == 'load_template_list') {
	...
	$q = "SELECT * FROM `gs_templates` ORDER BY `name` ASC";
	$r = mysqli_query($ms, $q);
