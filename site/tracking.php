...
include ('custom/service_new.php');
checkUserSession();
...
<head>
	...
	<script type="text/javascript" src="js/leaflet/leaflet.routingmachine.js?v=<? echo $gsValues['VERSION_ID']; ?>"></script>
	...
	<script type="text/javascript" src="js/leaflet/l.kml.js?v=<? echo $gsValues['VERSION_ID']; ?>"></script>
	...
	<script type="text/javascript" src="js/jquery.flot.pie.min.js?v=<? echo $gsValues['VERSION_ID']; ?>"></script>
	<script type="text/javascript" src="js/jquery.flot.categories.min.js?v=<? echo $gsValues['VERSION_ID']; ?>"></script>
	...
	if (file_exists('js/src/gs.tracking.js')) {
		?>
		<script type="text/javascript" src="js/src/gs.share.js"></script>
		<script type="text/javascript" src="js/src/gs.dashboard.js"></script>
		...
		<script type="text/javascript" src="js/src/gs.expenses.js"></script>
		...
		<script type="text/javascript" src="js/src/gs.tachograph.js"></script>
		...
		<script type="text/javascript" src="js/src/gs.settings.kml.js"></script>
...
<body onload="load()" onUnload="unload()">
	...
	<div id="content" style="visibility: hidden;">
		...
		<? include ("inc/inc_dialogs.events_camera.php"); ?>
		
		<? include ("inc/inc_dialogs.graphics_bluetooth.php"); ?>
	</div>
</body>
