...
?>
<?php
$canEdit = ($_SESSION["cpanel_privileges"] === 'super_admin' || $_SESSION["cpanel_privileges"] === 'admin');
?>

<div id="dialog_settings_kml_properties" title="<? echo $la['KML_PROPERTIES']; ?>">
	<div class="row">
		<div class="row2">
		...
		<div class="row2">
			<div class="width30"><? echo $la['KML_FILE']; ?></div>
			...
			<div class="width24"><input id="dialog_settings_kml_upload" class="button float-right width100" type="button" value="<? echo $la['UPLOAD']; ?>" onclick="settingsKMLUpload();" /></div>
		</div>
	</div>

	<center>
		<input class="button icon-save icon" type="button" onclick="settingsKMLProperties('save');" value="<? echo $la['SAVE']; ?>" />&nbsp;
		<input class="button icon-close icon" type="button" onclick="settingsKMLProperties('cancel');" value="<? echo $la['CANCEL']; ?>" />
	</center>
</div>
			...
			<div class="container last">
				...
				<div class="row2">
					<div style="height: 305px; overflow-y: scroll;">
						...
						<div class="row"><? echo $la['VAR_TEMPLATE_ROUTE']; ?></div>
						<div class="row"><? echo $la['VAR_TEMPLATE_ZONE']; ?></div>
						...
						<div class="row"><? echo $la['VAR_TEMPLATE_VIN']; ?></div>
						<div class="row"><? echo $la['VAR_TEMPLATE_PL_NUM']; ?></div>
						<div class="row"><? echo $la['VAR_TEMPLATE_SIM_NUMBER']; ?></div>
	...
	<div class="row">
		...
		<div class="block width50">
			<div class="container">
				...
				<div class="row2">
					<div class="width40"><? echo $la['ZONES_SHARED']; ?></div>
					<div class="width30"><input id="dialog_settings_subaccount_shared_available_zones" type="checkbox" /></div>
				</div>
			</div>
		</div>
		...
		<div class="block width50">
			<div class="container last">
				<div class="row2">
					<div class="width70"><? echo $la['DASHBOARD']; ?></div>
				...
				<div class="row2" style="display: none;">
					<div class="width70"><? echo $la['TACHOGRAPH']; ?></div>
				...
				<div class="row2">
					<div class="width70"><? echo $la['SUB_EVENTS']; ?></div>
					<div class="width30"><input id="dialog_settings_subaccount_events" type="checkbox" /></div>
				</div>

				<div class="row2">
					<div class="width70"><? echo $la['API']; ?></div>
					<div class="width30">
						<select id="dialog_subaccount_edit_api_active" class="select width100">
							<option value="true"><? echo $la['YES']; ?></option>
							<option value="false"><? echo $la['NO']; ?></option>
							<option value="new"><? echo $la['NEW']; ?></option>
						</select>
					</div>
				</div>
				<div class="row2">
					<div class="width70"><? echo $la['API_KEY']; ?></div>
					<div class="width30"><input id="dialog_subaccount_edit_api_key" class="inputbox width100" readOnly="true" /></div>
				</div>
			</div>
		</div>
	</div>
...
<div id="dialog_settings_event_properties" title="<? echo $la['EVENT_PROPERTIES']; ?>">
	<div id="settings_event">
		<ul>
			...
			<li><a href="#settings_event_webhook"><? echo $la['WEBHOOK']; ?></a></li>
			<li id="settings_event_object_control_tab"><a href="#settings_event_object_control"><? echo $la['OBJECT_CONTROL']; ?></a></li>
		</ul>
					...
					<div class="container">
						...
						<div class="row2">
							...
							<div class="width60">
								...
								<option value="dismount"><? echo $la['DISMOUNT']; ?></option>
								<option value="disassem"><? echo $la['DISASSEMBLE']; ?></option>
								...
								<option value="driverch"><? echo $la['DRIVER_CHANGE']; ?></option>
								<option value="trailerch"><? echo $la['TRAILER_CHANGE']; ?></option>
								...
								<option value="zone_in_stop_engine"><? echo $la['ZONE_IN_STOP_ENGINE']; ?></option>
								</select>
							</div>
						</div>
						<div class="row2">
						...
						<div class="row2">
							...
							<div class="width60">
								<select id="dialog_settings_subaccounts_object_list" class="select-multiple-search width100" multiple="multiple" /></select>
							</div>
						</div>
						<div class="row2">
						...
						<div class="row2">
							...
							<div class="width60">
								<input class="inputbox width100" id="dialog_settings_event_time_period" type="text" maxlength="4" disabled inputmode="numeric" pattern="[0-9]*" onkeypress="return isNumberKey(event);" onpaste="return false" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
							</div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['TIME_PERIOD_HRS']; ?></div>
							<div class="width5"><input id="dialog_settings_event_time_period_check" type="checkbox" checked="checked" onclick="settingsEventSwitchTimeCheck();" /></div>
							<div class="width55">
								<select id="dialog_settings_event_time_period_hrs" class="select width100">
		...
		<div id="settings_event_notification">
			<div class="row">
				...
				<div class="row2">
					...
					<div class="width5"></div>
						<div class="width5">
							<input id="dialog_settings_event_notify_sms" type="checkbox" class="checkbox" onchange="if(this.checked){var tg=document.getElementById('dialog_settings_event_notify_telegram'); if(tg)tg.checked=false;}" />
						</div>
					<div class="width45">
			...
			<?php if ($_SESSION['privileges'] == 'super_admin' || $_SESSION['privileges'] == 'admin') { ?>
					<div class="row2">
						...
						<div class="width5">
							<input
								id="dialog_settings_event_notify_telegram"
								type="checkbox"
								class="checkbox"
								onchange="if(this.checked){var sms=document.getElementById('dialog_settings_event_notify_sms'); if(sms)sms.checked=false;}"
								<?php if (!$canEdit) echo 'disabled'; ?> />
						</div>
						<div class="width45">
							<input
								id="dialog_settings_event_telegram_chat_id"
								class="inputbox"
								type="text"
								value=""
								maxlength="500"
								placeholder="<? echo $la['TELEGRAM_CHAT_IDS_PLACEHOLDER']; ?>"
								<?php if (!$canEdit) echo 'disabled'; ?> />
						</div>
					</div>
					<div id="dialog_settings_event_telegram_token_row" class="row2" style="display:none;">
						<div class="width45">Token de vinculación</div>
						<div class="width5"></div>
						<div class="width5"></div>
						<div class="width45">
							<div style="display:flex; align-items:center; gap:6px; width:100%;">
								<input
									id="dialog_settings_event_telegram_token"
									class="inputbox"
									type="text"
									value=""
									readonly
									style="flex:1; min-width:0; background:#f8f8f8; color:#555; font-size:12px;"
									placeholder="Token de vinculación" />
								<button
									type="button"
									onclick="var el=document.getElementById('dialog_settings_event_telegram_token');el.select();document.execCommand('copy');notifyBox('info','','Token copiado');"
									style="padding:4px 10px; cursor:pointer; border:1px solid #aaa; background:#fff; border-radius:3px; font-size:12px; white-space:nowrap; flex-shrink:0;"
...
<div id="dialog_settings_object_group_properties" title="<? echo $la['OBJECT_GROUP_PROPERTIES']; ?>">
	<div class="row">
		...
		<div class="title-block"><? echo $la['WEBSERVICE']; ?></div>
		<div class="container last"></div>
		<div class="row2">
			<div class="width40"><? echo $la['NAME_API']; ?></div>
			<div class="width60"><input id="dialog_settings_object_group_name_api" class="inputbox" type="text" value="" maxlength="50" <?php echo !$canEdit ? 'disabled' : ''; ?>></div>
		</div>
		<div class="row2">
			<div class="width40"><? echo $la['PASS_API']; ?></div>
			<div class="width60"><input id="dialog_settings_object_group_api_pass" class="inputbox" type="text" value="" maxlength="200" <?php echo !$canEdit ? 'disabled' : ''; ?>></div>
		</div>
	</div>
...
<div id="dialog_settings_object_driver_properties" title="<? echo $la['OBJECT_DRIVER_PROPERTIES']; ?>">
	<div style="height: 500px; overflow-y: scroll;">
		<div class="container">
			<div class="row">
				<div class="title-block"><? echo $la['DRIVER']; ?></div>
				<div class="report-block block width100">
					<div class="container">
						<div class="row2" style="height: 80px; vertical-align: middle; text-align: center; display: table;">
							<img id="dialog_settings_object_driver_photo" style="border:0px; width: 80px;" src="img/user-blank.svg" onclick="settingsObjectDriverPhotoDownload();" />
						</div>
						<center>
			...
			<div class="container">
				<div class="row">
					<div class="title-block"><? echo $la['DRIVER_DOCUMENTS']; ?></div>
					<div class="report-block block width50">
						<div class="container">
							<div class="row2" style="height: 50px; vertical-align: middle; text-align: center; display: table;">
								<img id="dialog_settings_object_licence_photo" style="border:0px; width: 50px;" src="img/id.svg" onclick="settingsObjectLicencePhotoDownload();" />
							</div>
							<center>
								<input class="button" type="button" value="<? echo 'Licencia' ?>" onclick="settingsObjectLicencePhotoUpload();" />&nbsp;
								<input class="button" type="button" value="<? echo $la['DELETE']; ?>" onclick="settingsObjectLicencePhotoDelete();" />
							</center>
						</div>
					</div>
					<div class="report-block block width50">
						<div class="container">
							<div class="row2" style="height: 50px; vertical-align: middle; text-align: center; display: table;">
								<img id="dialog_settings_object_id_photo" style="border:0px; width: 50px;" src="img/id.svg" onclick="settingsObjectIdPhotoDownload();" />
							</div>
							<center>
								<input class="button" type="button" value="<? echo 'Identificacíon'; ?>" onclick="settingsObjectIdPhotoUpload();" />&nbsp;
								<input class="button" type="button" value="<? echo $la['DELETE']; ?>" onclick="settingsObjectIdPhotoDelete();" />
							</center>
						</div>
					</div>
					<div class="report-block block width50">
						<div class="container">
							<div class="row2" style="height: 50px; vertical-align: middle; text-align: center; display: table;">
								<img id="dialog_settings_object_nss_photo" style="border:5px; width: 50px;" src="img/otro.svg" onclick="settingsObjectNssPhotoDownload();" />
							</div>
							<center>
								<input class="button" type="button" value="<? echo 'Seguro Social'; ?>" onclick="settingsObjectNssPhotoUpload();" />&nbsp;
								<input class="button" type="button" value="<? echo $la['DELETE']; ?>" onclick="settingsObjectNssPhotoDelete();" />
							</center>
						</div>
					</div>
					<div class="report-block block width50">
						<div class="container">
							<div class="row2" style="height: 50px; vertical-align: middle; text-align: center; display: table;">
								<img id="dialog_settings_object_otro_photo" style="border:5px; width: 50px;" src="img/otro.svg" onclick="settingsObjectOtroPhotoDownload();" />
							</div>
							<center>
								<input class="button" type="button" value="<? echo 'Otro'; ?>" onclick="settingsObjectOtroPhotoUpload();" />&nbsp;
								<input class="button" type="button" value="<? echo $la['DELETE']; ?>" onclick="settingsObjectOtroPhotoDelete();" />
							</center>
						</div>
					</div>
				</div>
				<div class="report-block block width100">
					<div class="container last">
						<div class="row">
							<div class="title-block"><?php echo $la['DRIVER_INFO']; ?></div>
							<div class="row2">
								<div class="width40"><? echo $la['NAME']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_name" class="inputbox" type="text" value="" maxlength="50"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_RFC']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_rfc" class="inputbox" type="text" value="" maxlength="13"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_NSS']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_nss" class="inputbox" type="text" value="" maxlength="11"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_LICENSE']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_license" class="inputbox" type="text" value="" maxlength="20"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_LICENSE_EXPIRATION_DATE']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_licence_expiration" readonly class="inputbox-calendar inputbox width100" type="text" value="" maxlength="30"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_INE']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_ine" class="inputbox" type="text" value="" maxlength="18"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_INE_EXPIRATION_DATE']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_ine_expiration" readonly class="inputbox-calendar inputbox width100" type=" text" value="" maxlength="30"></div>
							</div>
							<div class="row2">
								<div class="width40"><? echo $la['DRIVER_CURP']; ?></div>
								<div class="width60"><input id="dialog_settings_object_driver_curp" class="inputbox" type="text" value="" maxlength="18"></div>
							</div>
							<div class="row2">
							...
							<div class="row2">
								<div class="width40"><? echo $la['EMPLOYEE_NUMBER']; ?></div>
	...
	<div id="dialog_settings_object_trailer_properties" title="<? echo $la['OBJECT_TRAILER_PROPERTIES']; ?>">
		<div class="row">
			...
			<div class="row2">
				<div class="width40"><? echo $la['ID_MAC']; ?></div>
			...
			<div class="row2">
				<div class="width40"><? echo $la['DESCRIPTION']; ?></div>
				<div class="width60"><textarea id="dialog_settings_object_trailer_desc" class="inputbox" style="height:50px;" maxlength=""></textarea></div>
			</div>
		</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="row2">
							...
							<div class="width50">
								<input id="dialog_settings_object_sensor_formula" class="inputbox" type="text" value="" maxlength="1500" placeholder="(X+1)/2*3" />
							</div>
						</div>
						<div class="row2">
			...
			<div class="width33 block">
				<div class="container last">
					<div class="row">
						...
						<div class="row2">
							<div class="width25">
								<input id="settings_object_sensor_dictionary_value" class="inputbox width90" type="text" value="" maxlength="50" disabled>
							</div>
							<div class="width10">
								=
							</div>
	...
	<div id="dialog_settings_object_service_properties" title="<? echo $la['SERVICE_PROPERTIES']; ?>">
		<div class="row">
			...
			<div class="block width50">
				<div class="container">
					<div class="row2">
						<div class="width50"><? echo $la['OBJECT']; ?></div>
						<div class="width50"><input id="dialog_settings_object_name" class="inputbox" type="text" value="" maxlength="30"></div>
					</div>
					<div class="row2">
						<div class="width50"><? echo $la['PLAN']; ?></div>
						<select id="dialog_settings_object_service_plan" class="select width50">
		...
		<div class="row">
			...
			<div class="block width50">
				<div class="container">
					...
					<div class="row2">
						<div class="width50"><? echo $la['CURRENT_ENGINE_HOURS'] . ' (' . $la["UNIT_H"] . ')'; ?></div>
					...
					<div class="row2">
						...
						<div class="width50">
							<input id="dialog_settings_object_service_notify_email_address" class="inputbox" type="text" value="" maxlength="500" placeholder="<? echo $la['EMAIL_ADDRESS']; ?>" />
						</div>
					</div>
				</div>
			</div>
	...
	<div id="dialog_settings_object_custom_field_properties" title="<? echo $la['CUSTOM_FIELD_PROPERTIES']; ?>">
		<div class="row">
			<div class="row2">
				<div class="width40"><? echo $la['NAME']; ?></div>
				<div class="width60"><input id="dialog_settings_object_custom_field_name" class="inputbox" type="text" maxlength="25" <?php echo !$canEdit ? 'disabled' : ''; ?>></div>
			</div>
			<div class="row2">
				<div class="width40"><? echo $la['VALUE']; ?></div>
				<div class="width60"><input id="dialog_settings_object_custom_field_value" class="inputbox" type="text" maxlength="400" <?php echo !$canEdit ? 'disabled' : ''; ?>></div>
			</div>
			<div class="row2">
	...
	<div id="dialog_settings_object_edit_accvirt" title="<? echo $la['VIRTUAL_ACC_PARAMETER_PROPERTIES']; ?>">
		<div class="row">
			<div class="row2">
				<div class="width60"><? echo $la['PARAMETER']; ?></div>
				<div class="width40"><select id="dialog_settings_object_edit_accvirt_param" class="select width100"></select></div>
			</div>
			<div class="row2">
				<div class="width60"><? echo $la['VIRT_ACC_EQ_1_IF_PARAMETER']; ?></div>
				<div class="width10">
			...
			<div class="row2">
				<div class="width60"><? echo $la['VIRT_ACC_EQ_0_IF_PARAMETER']; ?></div>
				<div class="width10">
		...
		<center>
			<input class="button icon-save icon" type="button" onclick="settingsObjectEditAccvirt('save');" value="<? echo $la['SAVE']; ?>" />&nbsp;
			<input class="button icon-close icon" type="button" onclick="settingsObjectEditAccvirt('cancel');" value="<? echo $la['CANCEL']; ?>" />
		</center>
	</div>
	...
	<div id="dialog_settings_object_edit" title="<? echo $la['EDIT_OBJECT']; ?>">
		<div id="settings_object">
			<ul>
				...
				<li><a href="#settings_object_info_ws"><? echo $la['API/WS']; ?></a></li>
			</ul>
			...
			<div id="settings_object_main">
				<div class="row">
					...
					<div class="row2">
						<div class="width40"><? echo $la['PLATE_NUMBER']; ?></div>
						<div class="width60"><input id="dialog_settings_object_edit_plate_number" class="inputbox" type="text" maxlength="15" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase();"></div>
					</div>
					<div class="row2">
					...
					<div class="row2">
						...
						<div class="width60"><input id="dialog_settings_object_edit_device" class="inputbox" type="text" maxlength="30" disabled></div>
					</div>
					<div class="row2">
						<div class="width40"><? echo $la['SIM_CARD_NUMBER']; ?></div>
						<div class="width60"><input id="dialog_settings_object_edit_sim_number" class="inputbox" type="text" value="" maxlength="30" disabled></div>
					</div>
					<div class="row2" style="display: <?php echo $status; ?>;">
						<div class="width40"><? echo $la['SIM_CARD_ICCID']; ?></div>
						<div class="width60"><input id="dialog_settings_object_edit_sim_iccid" class="inputbox" type="text" value="" maxlength="30" disabled></div>
					</div>
					<div class="row2" style="display: <?php echo $status; ?>;">
						<div class="width40"><? echo $la['FOTA']; ?></div>
						<div class="width60"><input id="dialog_settings_object_fota_teltonika" class="inputbox" type="text" value="" maxlength="30" disabled></div>
					</div>
					<div class="row2" style="display: <?php echo $status; ?>;">
						<div class="width40">
							<? echo $la['MAINTENANCE']; ?>
						...
						<div class="width60">
							<select id="dialog_settings_object_edit_mtto" class="select width100">
			...
			<div id="settings_object_icon">
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width60">
							<select id="dialog_settings_object_edit_map_icon" class="select width40" onchange="updateIconPreview()">
								<optgroup label="Tipo de ícono">
									<option value="arrow"><? echo $la['ARROW']; ?></option>
									<option value="icon"><? echo $la['ICON']; ?></option>
								</optgroup>
								<optgroup label="Marca del vehículo">
									<option value="img/markers/objects/new_tornado-van.svg">Tornado_van</option>
									<option value="img/markers/objects/new_peugeot-expert.svg">Peugeot_Expert</option>
									<option value="img/markers/objects/new_kangoo_front.svg">kangoo</option>
								</optgroup>
							</select>

							<div class="icon-preview">
								<img id="selected_icon_preview" src="" alt="Previsualización del ícono" />
							</div>
						</div>
					</div>
					...
					<script>
						function updateIconPreview() {
							const selector = document.getElementById('dialog_settings_object_edit_map_icon');
							const preview = document.getElementById('selected_icon_preview');
							const value = selector.value;

							if (value.endsWith('.svg') || value.endsWith('.png')) {
								preview.src = value;
			...
			<div id="settings_object_accuracy">
				<div class="scroll-y">
					<div class="row">
						...
						<div class="row2">
							<div class="width65"><? echo $la['MEASURE_ROUTE_LENGTH_USING']; ?></div>
							<div class="width5"></div>
							<div class="width30">
								<select id="settings_object_accuracy_route_length" class="select width100" />
								<option value="gps">GPS</option>
								<option value="odo"><? echo $la['ODOMETER_SENSOR']; ?></option>
								</select>
							</div>
						</div>
						<div class="row2">
					...
					<div class="row">
						...
						<div class="row2">
							<div class="width65"><span class="container"><? echo $la['ENABLE_VIRTUAL_ACC_PARAMETER']; ?></span></div>
							<div class="width5"></div>
							<div class="width5"><input id="settings_object_accuracy_accvirt" type="checkbox" class="checkbox" /></div>
							<div class="width25"><input style="width: 100%;" class="button" type="button" onclick="settingsObjectEditAccvirt('open');" value="<? echo $la['EDIT']; ?>" /></div>
						</div>
						<div class="row2">
							<div class="width65"><span class="container"><? echo $la['CLEAR_DETECTED_SENSOR_CACHE']; ?></span></div>
							<div class="width5"></div>
							<div class="width5"></div>
							<div class="width25"><input style="width: 100%;" class="button" type="button" onclick="settingsObjectClearDetectedSensorCache();" value="<? echo $la['CLEAR']; ?>" /></div>
						</div>
						<div class="row" style="display: <?php echo $status; ?>;">
							<div class="row2">
								<div class="width70"><? echo $la['ENABLE_FORDWARD']; ?></div>
								<div class="width25"><input id="settings_main_fordward" type="checkbox" class="checkbox" /></div>
							</div>
						</div>
					</div>
					<div class="row" style="display: <?php echo $status; ?>;">
						<div class="title-block"><? echo $la['STREAM_SERVER']; ?></div>
						<div class="row2">
							<div class="width40"><? echo $la['ENABLE_STREAM']; ?></div>
							<div class="width60"><input id="settings_main_stream" type="checkbox" class="checkbox" /></div>
						</div>

						<div class="row2">
							<div class="width40"><? echo $la['URL_STREAM']; ?></div>
							<div class="width60"><input id="dialog_settings_object_edit_url_stream" class="inputbox" type="text" value="" maxlength="250"></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['STREAM_SERVER_PORT']; ?></div>
							<div class="width60"><input id="dialog_settings_object_edit_port_stream" class="inputbox" type="text" maxlength="15"></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['TIME_TO_STREAM']; ?></div>
							<div class="width60">
								<select id="dialog_settings_object_edit_time_stream" class="select width100">
									<option value="120"><? echo $la['2_Min']; ?></option>
									<option value="180"><? echo $la['3_Min']; ?></option>
									<option value="300"><? echo $la['5_Min']; ?></option>
									<option value="600"><? echo $la['10_Min']; ?></option>
								</select>
							</div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['LEFT_TIME_TO_STREAM']; ?></div>
							<div class="width60"><input id="dialog_settings_object_edit_left_time_stream" class="inputbox" type="text" maxlength="15"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="settings_object_info_ws">
				<div id="settings_object_info_ws">
					<table id="settings_object_info_ws_grid"></table>
					<div id="settings_object_info_ws_grid_pager"></div>
				</div>
			</div>
		</div>
	...
	<div id="dialog_email_selected_services" title="<? echo $la['EMAIL_ADDRESS']; ?>">
		<div class="row">
			<div class="row2">
				<div class="width30"><? echo $la['EMAIL']; ?></div>
				<div class="width70"><input id="email_selected_services_imei" class="inputbox" type="text" maxlength="500"></div>
			</div>
		</div>

		<center>
			<input class="button icon-save icon" type="button" onclick="maintenanceServiceEmailSelected('add');" value="<? echo $la['SAVE']; ?>" />&nbsp;
			<input class="button icon-close icon" type="button" onclick="maintenanceServiceEmailSelected('cancel');" value="<? echo $la['CANCEL']; ?>" />
		</center>
	</div>
	...
	<div id="dialog_settings" title="<? echo $la['SETTINGS']; ?>">
		<div id="settings_main">
			<ul>
				...
				<li id="settings_main_kml_tab"><a href="#settings_main_kml"><? echo $la['KML']; ?></a></li>
				...
				<li id="settings_main_user_interface_tab"><a href="#settings_main_user_interface"><? echo $la['USER_INTERFACE']; ?></a></li>
			...
			<div id="settings_main_objects">
				...
				<div id="settings_main_objects_groups_drivers">
					<ul>
						...
						<li><a href="#settings_main_binnacle_list"><? echo $la['BINNACLE']; ?></a></li>
					</ul>
					...
					<div id="settings_main_binnacle_list">
						<table id="settings_main_binnacle_list_grid"></table>
						<div id="settings_main_binnacle_list_grid_pager"></div>
					</div>
				</div>
			</div>
			...
			<div id="settings_main_kml">
				<div class="info">
					<? echo $la['KML_ALLOWS_TO_IMPORT_AND_VISUALIZE_ADDITIONAL_DATA']; ?>
				</div>
			...
			<div id="settings_main_user_interface">
				...
				<div class="scroll-y">
					...
					<div class="row">
						<div class="title-block"><? echo $la['DASHBOARD']; ?></div>
						<div class="row2">
							<div class="width40"><? echo $la['OPEN_AFTER_LOGIN']; ?></div>
							<div class="width4">
					...
					<div class="row">
						...
						<div class="row2">
							<div class="width40"><? echo $la['OBJECT_DETAILS_POPUP_ON_CLUSTER_MOUSE_HOVER']; ?></div>
							<div class="width4">
					...
					<div class="row">
						...
						<div class="row2">
							<div class="width40"><? echo $la['STOP_ENGINE_COLOR']; ?></div>
							<div class="width4">
								<input id="settings_main_ohc_stop_engine" type="checkbox" class="checkbox" onchange="settingsCheckEngine();" />
							</div>
							<input class="color inputbox" style="width:55px" type="text" id="settings_main_ohc_stop_engine_color" disabled />
						</div>
						<div class="row2">
						...
						<div class="row2">
							...
							<div class="width10">
								<input class="color inputbox" style="width:55px" type="text" id="settings_main_ohc_engine_idle_color" />
							</div>
							<div class="width10">
								<input class="inputbox width100" id="settings_main_time_ohc_engine_idle" type="text" maxlength="4" disabled placeholder="Minutos" inputmode="numeric" pattern="[0-9]*" onkeypress="return isNumberKey(event);" onpaste="return false" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
							</div>
						</div>
					</div>
					<div class="row">
							...
							<div class="width25">
								<select id="settings_main_datalist_items" class="select-multiple-search width100" multiple="multiple">
									<optgroup label="<? echo $la['GENERAL']; ?>">
										...
										<option value="iccid"><? echo $la['SIM_CARD_ICCID']; ?></option>
				...
				<div class="scroll-y">
					...
					<div class="row">
						...
						<div class="row2">
							...
							<div class="width40"><input class="inputbox" id="settings_main_company" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['BUSINESS_NAME']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_business_name" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['BUSINESS_RFC']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_business_rfc" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['ADDRESS']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_address" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['POST_CODE']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_post_code" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['CITY']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_city" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['COUNTRY_STATE']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_country" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['PHONE']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_phone1" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['EMAIL']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_email1" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo $la['CONTACT_PAGE_URL'] ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_web" readonly></div>
						</div>

						<div class="title-block"><? echo $la['CONTACT_INFO']; ?></div>
						<div class="row2">
							<div class="width40"><? echo $la['NAME_SURNAME']; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_name_surname" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo 'Telefono de Contacto'; ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_phone2" readonly></div>
						</div>
						<div class="row2">
							<div class="width40"><? echo 'E-mail Ofertas y Promociones' ?></div>
							<div class="width40"><input class="inputbox" id="settings_main_email2" readonly></div>
						</div>
					...
					<div class="row">
						...
						<div class="row3">
							<div class="width40"><? echo $la['WEBHOOK_DAILY']; ?></div>
