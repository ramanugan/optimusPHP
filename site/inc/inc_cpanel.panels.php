	<div id="top_panel">
		<div class="tp-menu left-menu">
			...
			<div class="imei-server-btn">
				<a title="<? echo $la['IMEI_LIST']; ?>" id="top_panel_sim" href="#" onClick="switchCPTab('imei_list');">
					<img src="theme/images/sim.svg" />
					<span id="imei_list_stats"></span>
				</a>
			</div>
			<div class="device-server-btn">
				<a title="<? echo $la['IMEI_DEVICE_LIST']; ?>" id="top_panel_imei_device" href="#" onClick="switchCPTab('imei_device_list');">
					<img src="theme/images/vin.svg" />
					<span id="imei_device_list_stats"></span>
				</a>
			</div>
		...
		<div class="tp-menu right-menu">
			...
			<?php if (($_SESSION["cpanel_privileges"] == 'super_admin') || ($_SESSION["cpanel_privileges"] == 'admin')) { ?>
				<div class="help-btn">
					<a title="<?php echo $la['HELP']; ?>" href="https://sites.google.com/view/soporte-optimusgps/inicio" target="_blank">
	...
	<div id="cpanel_imei_list" style="display:none;">
		<div class="float-left cpanel-title">
			<div class="version">v<? echo $gsValues['VERSION']; ?></div>
			<h1 class="title"><? echo $la['CONTROL_PANEL']; ?> <span> - <? echo $la['IMEI_LIST']; ?></span></h1>
		</div>
			<table id="cpanel_imei_list_grid"></table>
		<div id="cpanel_imei_list_grid_pager"></div>
	</div>

	<div id="cpanel_imei_device_list" style="display:none;">
		<div class="float-left cpanel-title">
			<div class="version">v<? echo $gsValues['VERSION']; ?></div>
			<h1 class="title"><? echo $la['CONTROL_PANEL']; ?> <span> - <? echo $la['IMEI_DEVICE_LIST']; ?></span></h1>
		</div>
		<table id="cpanel_imei_device_list_grid"></table>
		<div id="cpanel_imei_device_list_grid_pager"></div>
	</div>
