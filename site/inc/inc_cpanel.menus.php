<ul id="cpanel_user_list_grid_action_menu" class="menu">
        ...
        <? if ($_SESSION["cpanel_privileges"] != 'manager') { ?>
                ...
                <li><a class="icon-export" href="#" onclick="exportar_user_csv();"><? echo "Exportar XLS";  ?></a></li>
        <? } ?>
...
<ul id="cpanel_object_list_grid_action_menu" class="menu">
        ...
        <? if ($_SESSION["cpanel_privileges"] != 'manager') { ?>
                ...
                <li><a class="icon-export" href="#" onclick="exportar_csv();"><? echo "Exportar CSV";  ?></a></li>
        <? } ?>
...
<? if ($_SESSION["cpanel_privileges"] != 'manager') { ?>
        ...
        <li><a class="icon-import" href="#" onclick="exportarcsv();"><? echo "Exportar CSV";  ?></a></li>
<? } ?>
</ul>
