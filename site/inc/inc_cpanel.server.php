...
<div id="cpanel_manage_server" style="display:none;">
	...
	<div id="manage_server_tabs" class="clearfix">
		<ul>
			...
			<li class="cp-billing"><a href="#manage_server_billing"><? echo $la['BILLING']; ?></a></li>
			...
			<div id="manage_server_server">
				<div class="width-1000">
					...
					<div class="row">
						...
						<div class="row2">
							<div class="width50">
								<? echo $la['RESET_SERVER_API_KEY']; ?>
							</div>
							<div class="width10">
								<input class="button width100" type="button" onclick="apiKeyReset();" value="<? echo $la['RESET']; ?>" />
							</div>
						</div>
						<div class="row2">
							<div class="width50">
								<? echo $la['RESTRICT_SERVER_API_ACCESS_BY_IP']; ?>
							</div>
							<div class="width50">
					...
					<div class="row">
						...
						<div class="row2">
							...
							<div class="width10">
								<input id="cpanel_manage_server_history_period" class="inputbox width100" onkeypress="return isNumberKey(event);" maxlength="4" placeholder="<? echo $la['EXAMPLE_SHORT']; ?> 30" <? if (file_exists('config.hosting.php')) {
																																																						echo ' disabled';
																																																					} ?> />
							</div>
						</div>
					...
					<div class="row">
						<div class="title-block"><? echo $la['MANAGMENT_EVENTS']; ?></div>
						<div class="row2">
							<div class="width50"><? echo $la['SEND_EMAIL_MAINTENACE']; ?></div>
							<div class="width10">
							...
							<div class="width39"><input id="cpanel_manage_server_backup_email" class="inputbox width100" maxlength="150" /></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="manage_server_user">
				<div class="width-1000">
					<div class="row">
						...
						<div class="row2">
							<div class="width50">
								<? echo $la['SHOW_HIDE_PASSWORD_BUTTON']; ?>
							</div>
							<div class="width10">
						...
						<div class="row3">
							...
							<div class="width10">
								<select id="cpanel_manage_server_user_show_update_dialog" class="select width100" />
								<option value="true"><? echo $la['YES']; ?></option>
								<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
					...
					<div class="row">
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_eventos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_alertas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_geocercas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_historial" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_buscar_gps" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_refrescar" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_compartir_unidad" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_agregar_unidad" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_mostrar_ocultar" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_seguimiento" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_historial_edit" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_vista_calle" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_enviar_comando" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_editar" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_ver_en_vivo" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_ver_eventos_camara" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_lista_datos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_lista_marcadores" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_lista_zonas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_lista_rutas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_acerca_de" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_info" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_configuracion" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_coordenadas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_buscar" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_reportes" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_tareas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_mantenimientos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_comandos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_grafica_combustible" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_grafica_temperatura" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_imagenes" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_chat" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_lenguaje" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_mi_cuenta" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_version_celular" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_gps" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_plantillas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_kml" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_gprs" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_sms" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_crear_eventos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_interfaz_usuario" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_subcuentas" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_grupos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_conductor" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_pasajero" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_trailer" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_logs" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_crear_reportes" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_ver_reportes" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_eliminar_reportes" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_editar_reportes" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_crear_mantenimiento" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_eliminar_mantenimientos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_editar_mantenimientos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_crear_comandos_gprs" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_crear_comandos_sms" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_plantillas_comandos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_programar_comandos" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_activar_desactivar_tools" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_marcadores_mapa" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_rutas_mapa" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
						...
						<div class="row2">
							...
							<div class="width20">
								<select id="cpanel_manage_server_perm_geocercas_mapa" class="select width100">
									<option value="true"><? echo $la['YES']; ?></option>
									<option value="false"><? echo $la['NO']; ?></option>
								</select>
							</div>
			...
			<div class="width-1000">
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width50">
							<input id="cpanel_manage_server_email_smtp_password" class="inputbox width70" maxlength="50" />
						</div>
					</div>
				</div>
			</div>
