<div id="dialog_cmd" title="<? echo $la['OBJECT_CONTROL']; ?>">
	<div id="cmd_tabs">
		<ul>
			...
			<li><a href="#cmd_sms_tab"><? echo $la['SMS']; ?></a></li>
						...
						<div class="row2">
							<? if ($_SESSION["cpanel_privileges"] == 'super_admin') { ?>
								...
								<div class="width55">
									...
									<input id="cmd_gprs_cmd" class="inputbox" type="text" value="" maxlength="556">
								</div>
							<? } else { ?>
								<div class="width20"><? echo $la['COMMAND']; ?></div>
								<div class="width9">
								...
								<div class="width1"></div>
								<div class="width55">
									<input id="cmd_gprs_cmd" class="inputbox" type="password" value="" maxlength="556">
								</div>
							<? } ?>
									...
									<div class="container last">
										<div class="row2">
											<? if ($_SESSION["cpanel_privileges"] == 'super_admin') { ?>
												<div class="width20"><? echo $la['COMMAND']; ?></div>
												<div class="width65">
													<input id="cmd_sms_cmd" class="inputbox" type="text" value="" maxlength="556">
												</div>
											<? } else { ?>
												<div class="width20"><? echo $la['COMMAND']; ?></div>
												<div class="width65">
													<input id="cmd_sms_cmd" class="inputbox" type="password" value="" maxlength="556">
												</div>
											<? } ?>
					...
					<div class="block width60">
						<div class="container">
							...
							<div class="row2">
								...
								<div class="width65">
									<select id="dialog_cmd_schedule_protocol" class="select-search width100" onchange="cmdScheduleProtocolSwitch();" disabled="true"></select>
								</div>
							</div>
							<div class="row2">
								<div class="width35"><? echo $la['GATEWAY']; ?></div>
								<div class="width65">
									<select id="dialog_cmd_schedule_cmd_gateway" class="select width100" onchange="cmdTemplateScheduleList()" />
							...
							<div class="row2">
								...
								<div class="width65">
									<select id="dialog_cmd_schedule_object_list" class="select-multiple-search width100" multiple="multiple" onchange="cmdTemplateScheduleList()"></select>
								</div>
							</div>
							<div class="row2">
